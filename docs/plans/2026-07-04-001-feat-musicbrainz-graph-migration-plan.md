...
- **Depth expansion beyond 2** — the first iteration is intentionally capped at depth 2 (KTD5); expanding to depth 3+ (which would reach farther artists like Frank Sinatra / The Beatles) is a deliberate follow-up once the depth-2 build is validated.
